...
#define CPDMA_DESC_TOPORT_ENABLE		BIT(20)
...
static void cpsw_slave_init(struct cpsw_slave *slave, struct cpsw_priv *priv)
{
	...
	slave_port += 1; /*ok335xs2 use regmii2 but i want the port to be recognized as eth0*/
#endif
...
#if defined(CONFIG_OK335XS2)
	mode = CPDMA_DESC_OWNER | CPDMA_DESC_SOP | CPDMA_DESC_EOP | CPDMA_DESC_TOPORT_ENABLE | (2<<16);
#else
