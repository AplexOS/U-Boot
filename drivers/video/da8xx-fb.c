...
#define WAIT_FOR_FRAME_DONE	1
#define NO_WAIT_FOR_FRAME_DONE	0
...
static inline void lcd_disable_raster(int wait_for_frame_done)
{
	u32 reg;
	u32 loop_cnt = 0;
	u32 stat;
...
static const struct display_panel disp_panel = {
	...
	static struct lcd_ctrl_config g_cfg = {
			&disp_panel,
			.ac_bias		= 255,
			.ac_bias_intrpt 	= 0,
			.dma_burst_sz		= 16,
...
#endif
       static struct da8xx_panel g_panel_4 = {
	...
	static struct da8xx_panel g_panel_5 = {
...
static struct da8xx_panel g_panel_7 = {
...
static struct da8xx_panel g_panel_8 = {
...
/* for sbc7109 12.1 and 8.0*/
static struct da8xx_panel g_panel_10 = {
...
void *video_hw_init(void)
{
	...
	u32 rev;
	char *p;
	char *ss = getenv("screensize");
	struct da8xx_panel *pp;

	if(!strcmp(ss,"800x480-5"))
		pp = &g_panel_5;
	else if(!strcmp(ss,"800x480-7"))
		pp = &g_panel_7;
	else if(!strcmp(ss,"800x600-8"))
		pp = &g_panel_8;
	else if(!strcmp(ss,"480x272-4"))
		pp = &g_panel_4;
	else if(!strcmp(ss,"800x600-10"))
		pp = &g_panel_10;
	
#if defined(CONFIG_OK335XD)					
	da8xx_video_init(pp,&g_cfg,16);					
#elif defined(CONFIG_OK335XS) || defined(CONFIG_OK335XS2)				
	da8xx_video_init(pp,&g_cfg,32);					
#endif
