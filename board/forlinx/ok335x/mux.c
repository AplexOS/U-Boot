...
static struct module_pin_mux uart0_pin_mux_spl[] = {
	{OFFSET(uart0_rxd), (MODE(7) | PULLUP_EN | RXACTIVE)},	/* UART0_RXD */
...
static struct module_pin_mux uart1_pin_mux[] = {
	{OFFSET(uart1_rxd), (MODE(0) | PULLUP_EN | RXACTIVE)},	/* UART0_RXD */
	{OFFSET(uart1_txd), (MODE(0) | PULLUDEN)},		/* UART0_TXD */
	{-1},
};
...
static struct module_pin_mux led_pin_mux[] = {
        ...
        {OFFSET(gpmc_a2), MODE(7) | PULLUP_EN | RXACTIVE},         /* GPIO1_18 */
        {OFFSET(gpmc_a3), MODE(7) | PULLUP_EN | RXACTIVE},         /* GPIO1_19 */
        {-1},
};

static struct module_pin_mux led_pin_mux_s[] = {
        {OFFSET(mcasp0_axr0), MODE(7) | PULLUP_EN | RXACTIVE},         /* GPIO3_16 */
        {-1},
};

static struct module_pin_mux led_pin_mux_s2[] = {
        {OFFSET(gpmc_ad12), MODE(7) | PULLUP_EN | RXACTIVE},         /* GPIO1_12 */
        {OFFSET(gpmc_ad13), MODE(7) | PULLUP_EN | RXACTIVE},         /* GPIO1_13 */
        {OFFSET(gpmc_ad14), MODE(7) | PULLUP_EN | RXACTIVE},         /* GPIO1_14 */
        {OFFSET(gpmc_ad15), MODE(7) | PULLUP_EN | RXACTIVE},         /* GPIO1_15 */
        {-1},
};
...
static struct module_pin_mux backlight_pin_mux[] = {
        {OFFSET(ecap0_in_pwm0_out), MODE(7) | PULLUP_EN | RXACTIVE},         /* GPIO0_7 */
        /**
          * zengjf 2015-9-26 add for control lcd enable
          */
        {OFFSET(uart1_ctsn), MODE(7) | PULLUDDIS | RXACTIVE},         /* GPIO0_7 */
        {-1},
};
#endif
...
#endif
/*for sbc-7109 max ttl select model*/
static struct module_pin_mux maxttl_model_pin_mux[] = {
	{OFFSET(gpmc_ad8), MODE(7) | PULLUDEN | PULLUP_EN},		/* mode 0 */
	{OFFSET(gpmc_ad9), MODE(7) | PULLUDEN | RXACTIVE},	/* mode 1 */
	{OFFSET(xdma_event_intr0), MODE(7) | PULLUDEN | RXACTIVE},	/*  */
	{-1},
};
/*
...
# if 0	
	...
	{buzzer_pin_mux, PROFILE_ALL, DEV_ON_BASEBOARD},
	{backlight_pin_mux, PROFILE_ALL, DEV_ON_BASEBOARD},
	{led_pin_mux_s, PROFILE_ALL, DEV_ON_BASEBOARD},
#elif defined(CONFIG_OK335XS2)
	{buzzer_pin_mux, PROFILE_ALL, DEV_ON_BASEBOARD},
	{backlight_pin_mux, PROFILE_ALL, DEV_ON_BASEBOARD},
	{led_pin_mux_s2, PROFILE_ALL, DEV_ON_BASEBOARD},
#elif defined(CONFIG_OK335XD)
	{backlight_pin_mux, PROFILE_ALL, DEV_ON_BASEBOARD},
