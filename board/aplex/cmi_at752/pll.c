...
static void per_clocks_enable(void)
{
	...
	/*make lcd pixel clock come from per_pll*/
	__raw_writel(0x2, 0x44e00534);

	/*LCDC*/		
	__raw_writel(PRCM_MOD_EN, CM_PER_LCDC_CLKCTRL);
	while (__raw_readl(CM_PER_LCDC_CLKCTRL) != PRCM_MOD_EN);
}
