...
#define CONFIG_SYS_LDSCRIPT		"board/ecm_5206/u-boot.lds"
...
#define NANDARGS \
	...
	"nandargs=setenv bootargs console=ttyO0,115200n8 init=/sbin/init mem=256M vram=50M coherent_pool=2M" \
		"${optargs} " \
		"root=${nandroot} " \
...
#define CONFIG_EXTRA_ENV_SETTINGS \
	...
	"findfdt=setenv fdtfile am335x-ecm_5206.dtb\0" \
    "auto_update_nand= echo ------------------Begin update system to Nand -----------------;"\
        ...
        "fatload mmc 0 81000000 am335x-ecm_5206.dtb; nandecc hw 8; nand write.i 81000000 700000 ${filesize}; "\
