...
#define	CONFIG_EXTRA_ENV_SETTINGS					\
		...
		"bootargs=console=ttymxc0,115200 init=/init video=mxcfb0:dev=lcd,SEIKO-WVGA@60,bpp=32,if=RGB24 video=mxcfb1:off fbmem=50M fb0base=0x27b00000 vmalloc=400M androidboot.console=ttymxc0 androidboot.hardware=freescale \0" \
		"lvds_num=1\0"             

#endif
		//"bootargs=console=ttymxc0,115200 init=/init video=mxcfb0:dev=lcd,CLAA-WVGA@60,bpp=32,if=RGB24 video=mxcfb1:off fbmem=50M fb0base=0x27b00000 vmalloc=400M androidboot.console=ttymxc0 androidboot.hardware=freescale \0" \
		//"bootargs=console=ttymxc0,115200 init=/init video=mxcfb0:dev=ldb,800x480@60,if=RGB666,bpp=32 video=mxcfb1:off fbmem=50M fb0base=0x27b00000 vmalloc=400M androidboot.console=ttymxc0 androidboot.hardware=freescale \0" \
		//"bootargs=console=ttymxc0,115200 wifi_active=off init=/init mxcfb0:dev=lcd,CLAA-WVGA,if=RGB666 video=mxcfb1:off video=mxcfb2:off fbmem=30M fb0base=0x27b00000 vmalloc=400M androidboot.console=ttymxc0 androidboot.hardware=freescale\0" \
		...
		//"bootargs=console=ttymxc0,115200 wifi_active=off init=/init video=mxcfb0:dev=mipi_dsi,TRULY-WVGA,if=RGB24 video=mxcfb1:off video=mxcfb2:off fbmem=30M fb0base=0x27b00000 vmalloc=400M androidboot.console=ttymxc0 androidboot.hardware=freescale\0" \
		//"bootargs=console=ttymxc0,115200 wifi_active=off init=/init video=mxcfb0:dev=ldb,bpp=32 video=mxcfb1:off video=mxcfb2:off fbmem=30M fb0base=0x27b00000 vmalloc=400M androidboot.console=ttymxc0 androidboot.hardware=freescale\0" \
